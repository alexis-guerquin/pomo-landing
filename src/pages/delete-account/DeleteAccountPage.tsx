...
export default function DeleteAccountPage() {
  ...
  const copy = isFrench
    ? {
        ...
        data: 'La demande porte sur votre compte et les données associées, notamment vos informations de profil, projets, sessions, statistiques, réglages, progression et éléments sociaux. Certaines données peuvent être conservées lorsque la loi l’impose ou pour prévenir la fraude et les abus ; nous vous l’indiquerons si cela s’applique.',
    ...
    : {
        ...
        data: 'The request covers your account and associated data, including profile information, projects, sessions, statistics, settings, progress, and social content. Some data may be retained where required by law or to prevent fraud and abuse; we will tell you when that applies.',
