...
export default function PrivacyPage() {
  ...
  const copy = fr ? {
    ...
    sections: [
      ...
      ['Abonnements et achats', 'Les achats Android sont facturés par Google Play. RevenueCat nous aide à valider les achats et à synchroniser vos droits Premium entre vos appareils. À cette fin, Google Play et RevenueCat traitent un identifiant utilisateur pseudonyme, le produit acheté, l’état et les dates de l’abonnement, ainsi que des informations techniques sur l’application, l’appareil et la boutique. POCHA et RevenueCat ne reçoivent pas vos coordonnées bancaires. Vous pouvez gérer ou résilier votre abonnement dans Google Play.'],
    ...
    sections: [
      ...
      ['Subscriptions and purchases', 'Android purchases are billed by Google Play. RevenueCat helps us validate purchases and synchronise your Premium entitlement across devices. For this purpose, Google Play and RevenueCat process a pseudonymous user identifier, the purchased product, subscription status and dates, and technical information about the app, device, and store. POCHA and RevenueCat do not receive your payment card details. You can manage or cancel your subscription in Google Play.'],
      ...
      ['Recipients and hosting', 'Data is available only to providers needed to operate the service, including hosting, authentication, Google Play for billing, and RevenueCat for subscription management. The website uses Vercel Analytics for aggregated traffic measurement. We do not sell personal data.'],
